...
# 训练参数值
data_path = 'D:\\PYprogram\\Pytorch-MTCNN-master\\dataset\\24\\all_data'
batch_size = 384
learning_rate = 1e-3
epoch_num = 22
model_path = '../models'
...
if __name__ == '__main__':
    ...
    for epoch in range(epoch_num):
        ...
        torch.jit.save(torch.jit.script(model), os.path.join(model_path, 'RNet68.pth'))
